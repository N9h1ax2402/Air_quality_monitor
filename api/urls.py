...
urlpatterns = [
    ...
    path("rooms/<int:room_id>/humidity", get_report_list, name="get_humidity_report_list"),
    # path("rooms/<int:room_id>/temperature", get_temperature_report, name="get_temperature_report"),
    path("rooms/<int:room_id>/temperature", get_report_list, name="get_temperature_report"),
